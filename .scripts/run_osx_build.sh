...
validate_recipe_outputs "cf-autotick-bot-test-package-feedstock-v32"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="cf-autotick-bot-test-package-feedstock-v32" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi