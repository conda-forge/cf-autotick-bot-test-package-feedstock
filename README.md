...
Installing `bar` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating bar-feedstock
======================

If you would like to improve the bar recipe or build a new
...
Note that all branches in the conda-forge/bar-feedstock are
